...
pub trait CostCalculation {
    fn calculate_cost(&self, start: &Vertex, current: &Vertex, target: &Vertex) -> u32;
}

pub struct SimpleCalculator;
impl CostCalculation for SimpleCalculator {
    fn calculate_cost(&self, start: &Vertex, current: &Vertex, target: &Vertex) -> u32 {
...
impl CostCalculation for HaversineCalculator {
    fn calculate_cost(&self, start: &Vertex, current: &Vertex, target: &Vertex) -> u32 {
